...
This is a Power BI Sales Dashboard built to analyze sales, profit, cost, and shipments for a chocolate company. The dashboard provides actionable insights into sales performance across products, regions, and salespersons, transforming raw business data into interactive visual analytics.

The purpose of this project is to demonstrate practical Power BI skills, including data modeling, DAX calculations, time-intelligence analysis, and interactive report design.
...
**Project Video**
I have also created a walkthrough video of this dashboard. It will be shared on LinkedIn soon.

**How to Use**

1. Open the Power BI .pbix file in Power BI Desktop.
2. Explore the dashboard using slicers, bookmarks, and interactive visuals.
